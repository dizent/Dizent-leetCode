package other.paperPublicationResults;
...
public class Solution {
    ...
    static String[] types = new String[]{
            "ISSN论文数", "SCI论文数", "论文数", "被引用次数", "论文数/每百张开放床位数"
    };
        ...
        for (; startYear <= endYear; startYear++) {
            ...
            for (int month = 1; month <= 12; month++) {
                ...
                for (int index = 0; index < firstDepts.length; index++) {
                    ...
                    jedis.hset("paperPublicationResult_hash", startYear + "_" + month, monthResult);
                }
            }
            for (int i = 0; i < department_names.length; i++) {
                ...
                yearObj.put("firstDept", "门诊科室");
                yearObj.put("secondDept", department_names[i]);
                ...
                jedis.hset("paperPublicationResult_hash", startYear + "#", yearResult);
            }
        }
